...
//          System.err.println(encoder.encode(outputStream.toByteArray()));  
    ...
    public static void main(String[] args) throws InvalidAtributeException {  
        ...
        String encode = ToolsBarcode.generateBarCode("6936983800013","0.5","30");
        String encode2 = ToolsBarcode.generateBarCode128("69369833450938430579753045230800013","0.5","30");
